        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
              ...
              <p class="text-lead text-white">"Once a new technology rolls over you, if you're not part of the steamroller, you're part of the road"</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card z-index-0 shadow">
              <div class="card-header text-center pt-4">
                ...
                <ul class="list-inline">
                       ...
                       <li class="list-inline-item"><a href="<?php echo $client->createAuthUrl(); ?>"><i class="fa fa-google"></i></a> </li>
