...
<head>
    ...
    <body>
    <header>
    <div class="page-header min-height-400" style="background-image: url('../assets/img/home-decor-1.jpg');" loading="lazy">
            ...
            <div class="row py-5">
              <div class="col-lg-7 col-md-7 z-index-2 position-relative px-md-2 px-sm-5 mx-auto">
                ...
                <p class="text-lg mb-0">
                  ...
                  you more equanimous. <br><a href="postdetails.php" class="text-info icon-move-right">More about me
                    <i class="fa fa-arrow-right text-sm ms-1"></i>
                  </a>
                </p>
              </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="card card-plain">
              <div class="card-header p-0 position-relative">
                <a class="d-block blur-shadow-image">
                  <img src="../assets/img/home-decor-2.jpg" alt="img-blur-shadow" class="img-fluid shadow border-radius-lg" loading="lazy">
                </a>
              </div>
              <div class="card-body px-0">
                <h5>
                  <a href="postdetails.php" class="text-dark font-weight-bold">Rover raised $65 million</a>
                </h5>
                <p>
                  Finding temporary housing for your dog should be as easy as
                  renting an Airbnb. That’s the idea behind Rover ...
                </p>
                <a href="postdetails.php" class="text-info text-sm icon-move-right">Read More
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="card card-plain">
              <div class="card-header p-0 position-relative">
                <a class="d-block blur-shadow-image">
                  <img src="../assets/img/HighBeastImg/thisisengineering-raeng_1.jpg" alt="img-blur-shadow" class="img-fluid shadow border-radius-lg" loading="lazy">
                </a>
              </div>
              <div class="card-body px-0">
                <h5>
          ...
          <div class="col-lg-3 col-md-12 col-12">
            <div class="card card-blog card-background cursor-pointer">
              <div class="full-background" style="background-image: url('../assets/img/HighBeastImg/thisisengineering-raeng-2.jpg')" loading="lazy"></div>
              <div class="card-body">
