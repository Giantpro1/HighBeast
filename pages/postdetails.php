            ...
            <div class=" col-lg-9   mb-5 mb-lg-0">
              <article>
                <div class="post-slider mb-4">
                  <img src="../assets/img/home-decor-2.jpg" class="card-img" alt="post-thumb">
                </div>
                ...
                <ul class="card-meta my-3 list-inline">
                  <li class="list-inline-item">
                    <a href="author-single.html" class="avatar avatar-sm rounded-circle">
                  ...
                  <li class="list-inline-item">
                    <ul class="card-meta-tag list-inline">
                      <li class="list-inline-item"><a href="tags.html">#software</a></li>
                ...
                <div class="mb-5 border-top mt-4 pt-5">
                    ...
                    <div class="media d-block d-sm-flex mb-4 pb-4">
                        <a class="d-inline-block mr-2 mb-3 mb-md-0" href="#">
                            <img src="../assets/img/team-3.jpg" class="avatar avatar-sm rounded-circle" alt="">
                        </a>
                    ...
                    <div class="media d-block d-sm-flex">
                        <div class="d-inline-block mr-2 mb-3 mb-md-0" href="#">
                            ...
                            <a href="#!"><img src="../assets/img/ivancik.jpg" class="avatar avatar-sm rounded-circle" alt=""></a>
                        </div>
                        <div class="media-body">
