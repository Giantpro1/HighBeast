...
<body class="g-sidenav-show bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="" target="_blank">
        <img src="../assets/img/HighBeastImg/beast@.jfif" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">HighBeast</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="../pages/profileTable.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    ...
    <div class="container-fluid">
      <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('../assets/img/HighBeastImg/theTechRobort.jpg'); background-position-y: 50%;">
            ...
            <div class="card-header pb-0 p-3">
              <div class="row">
                ...
                <div class="col-md-4 text-end">
                  <a href="javascript:;">
                    <i class="fa fa-user-edit text-secondary text-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Profile"></i>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div class="card h-100">
            ...
            <div class="card-body p-3">
             <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
               Molestiae enim est temporibus facilis similique dolores ab?
               Fuga nam praesentium suscipit molestiae, qui dolorum eius fugit hic sapiente,
                aperiam facere esse?</p>
             <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.
               Molestiae enim est temporibus facilis similique dolores ab?
               Fuga nam praesentium suscipit molestiae, qui dolorum eius fugit hic sapiente,
                aperiam facere esse?</p>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Upload new project</h5>
