...
<body class="">
    ...
    <section class="min-vh-100 mb-8">
      <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('../assets/img/HighBeastImg/thisisengineering-raeng_0.jpg');">
            ...
            <div class="card z-index-0 shadow">
              ...
              <div class="card-body">
                ...
                <p class="text-danger" id="form_Error"></p>
                  <div class="mb-3">
                    <input type="text" name="hBUser_Email" class="form-control" placeholder="Enter email" aria-label="email" aria-describedby="">
                  </div>
                  <div class="mb-3">
                    <input type="password" name="hBUser_Password" class="form-control" placeholder="password" aria-label="password" aria-describedby="">
                  </div>
